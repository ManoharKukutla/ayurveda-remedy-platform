...
const AddDoctor = () => {
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <p className='mb-3 text-lg font-medium text-white'>Add Doctor</p>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <button type='submit' className='bg-[#E78D00] px-10 py-3 mt-4 text-white rounded-full'>Add doctor</button>
